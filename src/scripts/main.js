...
function split(){
    date1.style.transform = "rotate(-"+(window.scrollY/10)+"deg) translate(-"+(window.scrollY/19.1)+"vw)";
    date2.style.transform = "rotate("+(window.scrollY/10)+"deg) translate("+(window.scrollY/19.1)+"vw)";
